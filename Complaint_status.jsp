...
try 
{
String query = "insert into tae_customers values(?, ?, ? , ? ,?,?,?,?,now(),null,null)";
pstmt = conn.prepareStatement(query);// create a statement
pstmt.setInt(1,cust_id ); // set input parameter 1
pstmt.setString(2,cust_name); // set input parameter 2
pstmt.setLong(3,cust_phno);
pstmt.setString(4,cust_complaint);// set input parameter 3
pstmt.setString(5,cust_address);
pstmt.setInt(6,emp_assigned);
pstmt.setString(7, cust_status);
pstmt.setString(8, cust_category);
             ...
             <table>
                 ...
                 <tr >
                     ...
                     <td>
                         ...
                         <b>Complaint :</b><%=cust_complaint%>
                         </br>
                         </br>
                         <b>Category : </b> <%=cust_category%>
                     </td>
                 </tr>
             </td>
